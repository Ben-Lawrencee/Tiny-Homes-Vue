<template>
  <div class="wrapper centre" style="margin-bottom: 10px; margin-top: 10px" id="background">
...
<g>
    ...
    <div id="mentor-profile-content">
      <h1>John Johnson</h1>
      <h1>Specialty</h1>
      <h1>Contact Information</h1>
      <h2>JohnJohnson@Homes.Tiny</h2>
      <button id="btn_expand" onclick="alert('Pre-expand'); expand();">Expand</button>
    </div>
  </div>
</template>
